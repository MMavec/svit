...
const CACHE_TTLS: Record<string, number> = {
	...
	'/council-votes': 6 * 60 * 60 * 1000,
	'/council': 30 * 60 * 1000,
	'/development': 15 * 60 * 1000,
	'/demolitions': 15 * 60 * 1000,
	'/permits': 15 * 60 * 1000,
	'/business-licences': 30 * 60 * 1000,
	'/assessment': 6 * 60 * 60 * 1000,
	'/ev-charging': 6 * 60 * 60 * 1000,
	'/mobility': 6 * 60 * 60 * 1000,
	'/cooling': 6 * 60 * 60 * 1000,
	'/heritage': 24 * 60 * 60 * 1000,
	'/amenities': 6 * 60 * 60 * 1000,
	'/patios': 24 * 60 * 60 * 1000,
	'/power-outages': 2 * 60 * 1000,
	'/emergency-alerts': 5 * 60 * 1000,
	'/public-land': 24 * 60 * 60 * 1000,
